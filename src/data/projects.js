export const projects = [
    ...
    {
        title: "OGSL (Outil de Gestion)",
        slug: "ogsl-gestion",
        category: "Desktop / Système",
        shortDescription: "Création d'un logiciel de bureau pour l'optimisation des processus logistiques et scolaires.",
        longDescription:
            "Développement d'un outil logiciel conçu pour la gestion et le suivi de processus spécifiques (Logistique/Scolarité). Le but est d'optimiser les flux de données et d'offrir une interface ergonomique pour les utilisateurs finaux.",
        context: "Projet de Conception Logicielle",
        problem:
            "Digitaliser et automatiser des processus de gestion manuels sujets aux erreurs.",
        solution:
            "Création d'une application robuste avec une gestion rigoureuse des données et des rapports détaillés.",
        tech: ["C#", "WinForms / WPF", "SQL", "Reporting"],
        features: [
            "Gestion des entités",
        ...
        highlights: ["Automatisation des tâches", "Gain de productivité"],
        screenshots: [],
